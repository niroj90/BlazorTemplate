...
namespace BlazorTemplate.ApiClient
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        {
            return GetWeatherForecastsAsync(input, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<PagedResultDtoOfWeatherForcastDto> GetWeatherForecastsAsync(PagedRequestDto input, System.Threading.CancellationToken cancellationToken)
        {
            if (input == null)
            ...
            try
            {
                ...
                {
                    var json_ = System.Text.Json.JsonSerializer.SerializeToUtf8Bytes(input, JsonSerializerSettings);
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PagedResultDtoOfWeatherForcastDto>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class PagedResultDtoOfWeatherForcastDto
    {

        [System.Text.Json.Serialization.JsonPropertyName("totalRecordCount")]
        public int TotalRecordCount { get; set; }

        [System.Text.Json.Serialization.JsonPropertyName("items")]
        public System.Collections.Generic.ICollection<WeatherForcastDto> Items { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.2.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class WeatherForcastDto
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.2.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PagedRequestDto
    {
